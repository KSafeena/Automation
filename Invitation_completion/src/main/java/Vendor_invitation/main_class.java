...
public class main_class {
	...
	@FindBy(xpath = "//input[@name=\"ifsc\"]") WebElement ifsc;
	@FindBy(xpath = "//a[@id=\"delete_document3_\"]")WebElement delete;
...
//			delete.click();
//			upload.click();
//			upload.sendKeys("C:\\Users\\REDMI\\Contacts\\Downloads\\Bank declation1");
//			start_upload.click();
			Thread.sleep(2000);
			update1.click();
			driver.switchTo().alert().accept();
