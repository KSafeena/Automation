...
public class English_auction {
	...
	@FindBy(xpath = "//input[@value=\"Submit\"]") WebElement reset;
	@FindBy(xpath = "//input[@placeholder=\"Enter New Password\"]")WebElement psw1;
	@FindBy(xpath = "//input[@name=\"login\"]") WebElement user_username;
	@FindBy(xpath = "//input[@name=\"password\"]") WebElement user_psw;
	@FindBy(xpath = "//input[@name=\"sighIn\"]") WebElement user_login;
	...
	@FindBy(xpath = "//input[@name=\"login\"]") WebElement user_newusername;
	@FindBy(xpath = "//input[@name=\"password\"]") WebElement user_newpsw;
	@FindBy(xpath = "//input[@name=\"sighIn\"]") WebElement user_newlogin;
	@FindBy(xpath = "//div[@class='user']//div[1]//a//span")WebElement logout1;
	@FindBy(xpath = "//div[@class=\"user\"]//div[1]//div//a")WebElement logout2;
	...
	void inviting_vendors() throws InterruptedException
	{
		...
		void change_psw() throws InterruptedException
		{
			...
			{
				if(options_role.get(i).getText().equals("Clients"))
				{
					options_role.get(i).click();
					System.out.println("The option selected is"+options_role.get(i).getText());
				}
			}
			name.sendKeys("rahulkumar");
			search.click();
			psw3.sendKeys("111");
			reset.click();
					
		}
		void user_login() throws InterruptedException
		{
			logout1.click();
			logout2.click();
			driver.switchTo().alert().accept();
			user_username.sendKeys("rahulkumar");
			user_psw.sendKeys("111");
			user_login.click();
			old_psw.sendKeys("111");
			new_psw.sendKeys("Bob@1234");
			confirm_psw.sendKeys("Bob@1234");
			submit1.click();
			user_newusername.sendKeys("rahulkumar");
			user_newpsw.sendKeys("Bob@1234");
			user_newlogin.click();
			Thread.sleep(50);
